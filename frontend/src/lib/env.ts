...
const schema = z.object({
  ...
  NEXT_PUBLIC_SEPOLIA_SENDER_ADDRESS: addressSchema.default(
    "0xc3ea3c53ed3504f4d527fccac5080249341ab185",
  ),
  NEXT_PUBLIC_BASE_SEPOLIA_TOKEN_B_ADDRESS: addressSchema.default(
    "0x20F061Db666A0BC3Fa631C52f8a65DdA287264A1",
  ),
  NEXT_PUBLIC_BASE_SEPOLIA_RECEIVER_ADDRESS: addressSchema.default(
    "0x66666fFD3b3595c6a45279e83CfDa770285bF1A7",
  ),
});
...
export const env = schema.parse({
  ...
  NEXT_PUBLIC_SEPOLIA_SENDER_ADDRESS:
    process.env.NEXT_PUBLIC_SEPOLIA_SENDER_ADDRESS,
  NEXT_PUBLIC_BASE_SEPOLIA_TOKEN_B_ADDRESS:
    process.env.NEXT_PUBLIC_BASE_SEPOLIA_TOKEN_B_ADDRESS,
  NEXT_PUBLIC_BASE_SEPOLIA_RECEIVER_ADDRESS:
    process.env.NEXT_PUBLIC_BASE_SEPOLIA_RECEIVER_ADDRESS,
});
